...
static const tool_def_t TOOLS[] = {
    ...
    {"memory_recall",
     ...
     "\"scope\":{\"oneOf\":[{\"type\":\"string\"},{\"type\":\"array\",\"items\":{\"type\":"
     "\"string\"}}]},\"topk\":{\"type\":\"integer\",\"default\":10},\"include_stale\":{"
    ...
    {"memory_search",
     ...
     "{\"type\":\"object\",\"properties\":{\"query\":{\"type\":\"string\"},"
     "\"project_key\":{\"type\":\"string\"},\"project_path\":{\"type\":\"string\"},"
     "\"kind\":{\"oneOf\":[{\"type\":\"string\"},{\"type\":\"array\",\"items\":{\"type\":"
     "\"string\"}}]},\"topk\":{\"type\":\"integer\",\"default\":10},\"include_stale\":{"
     "\"type\":\"boolean\",\"default\":false}},\"required\":[\"query\"]}"},

    {"memory_candidate",
     "Record a pending memory candidate. Candidates are not durable until validated and "
     "committed.",
     "{\"type\":\"object\",\"properties\":{\"text\":{\"type\":\"string\"},\"scope\":{"
     "\"type\":\"string\"},\"project_key\":{\"type\":\"string\"},\"project_path\":{\"type\":"
     "\"string\"},\"kind\":{\"type\":\"string\"},\"source\":{\"type\":\"string\"},"
     "\"source_ref\":{\"type\":\"string\"},\"confidence\":{\"type\":\"number\"},"
     "\"importance\":{\"type\":\"number\"}},\"required\":[\"text\"]}"},

    {"memory_validate",
     "Validate pending memory candidates against source hashes, freshness policy, duplicate "
     "checks, and conflicts.",
     "{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"},\"project_key\":{"
     "\"type\":\"string\"},\"dry_run\":{\"type\":\"boolean\",\"default\":true}},"
     "\"required\":[]}"},

    {"memory_commit", "Promote validated memory candidates into durable recallable memory.",
     "{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"},\"project_key\":{"
     "\"type\":\"string\"},\"dry_run\":{\"type\":\"boolean\",\"default\":false}},"
     "\"required\":[]}"},

    {"memory_feedback",
     "Report whether recalled memory was useful, stale, wrong, or ignored so ranking can adapt.",
     "{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"},\"outcome\":{"
     "\"type\":\"string\",\"enum\":[\"used\",\"ignored\",\"stale\",\"wrong\"]},\"note\":{"
     "\"type\":\"string\"}},\"required\":[\"id\",\"outcome\"]}"},

    {"memory_rebuild",
     "Rebuild memory manifests, vectors, and zvec collections when schema, vector version, or "
     "source state changes.",
     "{\"type\":\"object\",\"properties\":{\"project_key\":{\"type\":\"string\"},\"scope\":{"
     "\"type\":\"string\"},\"dry_run\":{\"type\":\"boolean\",\"default\":true}},"
     "\"required\":[]}"},

    {"memory_audit",
     "Audit memory freshness, source hash mismatches, conflicts, stale items, and rebuild "
     "requirements.",
...
char *cbm_mcp_initialize_response(const char *params_json) {
    ...
    yyjson_mut_obj_add_str(doc, impl, "name", "amaze");
