...
#define CBM_CONFIG_MEMORY_FRESHNESS_DAYS "memory_freshness_days"
...
/* Memory lifecycle hooks. These emit deterministic context for agent hook
 * systems and return 0 even before durable memory storage is configured. */
